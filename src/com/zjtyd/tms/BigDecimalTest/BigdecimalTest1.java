 ...
 * <p>
 * static int ROUND_HALF_DOWN − Rounding mode to round towards "nearest neighbor" unless both neighbors are
 * equidistant, in which case round down.
 * <p>
 * static int ROUND_HALF_EVEN − Rounding mode to round towards the "nearest neighbor" unless both neighbors are
 * equidistant, in which case, round towards the even neighbor.
 * <p>
 * static int ROUND_HALF_UP − Rounding mode to round towards "nearest neighbor" unless both neighbors are
 * equidistant, in which case round up.
 * <p>
 * static int ROUND_UNNECESSARY − Rounding mode to assert that the requested operation has an exact result, hence no
...
public class BigdecimalTest1
{
    ...
    public void testOne()
    {
        ...
        System.out.println("Division result is " + bg1.divide(bg2, 4, BigDecimal.ROUND_HALF_DOWN) + "\tROUND_HALF_DOWN");
