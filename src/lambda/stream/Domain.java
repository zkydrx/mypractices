...
public class Domain
{
    ...
    public void test4()
    {
        List<String> wordList = Arrays.asList("i", "love", "program", "java", "is", "a", "very", "good", "programing", "language");
    ...
    public void test14()
    {
        ...
        List<Student> studentList = students.stream().sorted((p1, p2) -> p1.getName().compareTo(p2.getName())).limit(2).collect(Collectors.toList());
