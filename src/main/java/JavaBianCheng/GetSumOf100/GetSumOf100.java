...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-08-31 Time: 11:20
 * Description: 编写一个在1，2，…，9（顺序不能变）数字之间插入+或-或什么都不插入， 使得计算结果总是100的程序，并输出所有的可能性。
 * 例如：1 + 2 + 34 – 5 + 67 – 8 + 9 = 100。
 * <p>
 * 思路： 可以看成是在数字中间插入运算符。插入 + - 或空位。那么每个空位有3种选择，加号，减号或者空。
...
public class GetSumOf100 {
	...
	/**
	 * 求和方法，输入一个String[]运算式子 数组要写成指定的格式,大于10的数之间要用""隔开。
	 *
	 * @param cal
	 * @return 表达式的和
	 * @see ["1","","4"<span
	 *      style="font-family: Arial, Helvetica, sans-serif;">,""</span>,"7","+","7"]
	 */
