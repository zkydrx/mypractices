package com.design.atguigu.mybatis.mybatis.mapper;
...
public interface MonsterAnnotation
{
    ...
    @Insert("INSERT INTO mybatis_monster_ (age,birthday,email,gender,name,salary) " + "VALUES(#{age},#{birthday},#{email},#{gender},#{name},#{salary})")
    ...
    //修改Monster
    @Update("UPDATE mybatis_monster_ SET age=#{age}, birthday=#{birthday}, " + "email = #{email},gender= #{gender}, " + "name=#{name}, salary=#{salary} " + "WHERE " +
