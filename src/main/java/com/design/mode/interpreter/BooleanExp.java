...
/**
 * The interface of our BooleanExp Interpreter BooleanExp definition is:
 * BooleanExp ::= VariableExp | Constant | OrExp | AndExp | NotExp | '('
 * BooleanExp ')' AndExp ::= BooleanExp 'and' BooleanExp OrExp ::= BooleanExp
 * 'or' BooleanExp NotExp ::= BooleanExp 'not' BooleanExp Constant ::= 'true' |
