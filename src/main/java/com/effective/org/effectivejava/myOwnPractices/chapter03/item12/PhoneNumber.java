...
package com.effective.org.effectivejava.myOwnPractices.chapter03.item12;
...
public final class PhoneNumber implements Cloneable, Comparable<PhoneNumber> {
	 ...
	 * will be "0123".
	 * <p>
	 * Note that there is a single space separating the closing parenthesis after
	 * the area code from the first digit of the prefix.
	 */
	@Override
