...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2021-03-16 Time: 19:50:00
 * Description: 470. 用 Rand7() 实现 Rand10() 已有方法 rand7 可生成 1 到 7
 * 范围内的均匀随机整数，试写一个方法 rand10 生成 1 到 10 范围内的均匀随机整数。
 * <p>
