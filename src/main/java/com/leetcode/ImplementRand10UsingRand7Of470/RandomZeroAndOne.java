...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2021-03-17 Time: 00:02:38
 * Description:
 * <p>
 * <p>
 * 有一个随机数发生器，以概率P产生0，概率(1-P)产生1，请问能否利用这个随机数发生器，
 * 构造出新的发生器，以1/2的概率产生0和1。请写明结论及推理过程。 (扩展题） 思路： 调用两次函数产生以下结果：
 * 00-->p*p--->此种情况无限循环。 01-->p*(1-p) 11-->(1-p)*(1-p)--->此种情况无限循环。 10-->
 * (1-p)*P
 */
