...
/**
 * Created with IntelliJ IDEA. Author: Abbot Date: 2018-03-24 Time: 22:11:58
 ...
 * element in the stack. Example: MinStack minStack = new MinStack();
 * minStack.push(-2); minStack.push(0); minStack.push(-3); minStack.getMin();
 * --> Returns -3. minStack.pop(); minStack.top(); --> Returns 0.
 ...
 * 出最小值的时候该如何处理呢，如何获得第二小的值呢？如果要去寻找又不是常量时间了。解决的方案是再维护一个栈，我们称为最小栈， 如果遇到更小的值则插入最小栈，
