...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-12-26 Time: 16:04
 ...
 * Output: false
 * <p>
 * Explanation: The array cannot be partitioned into equal sum subsets. Seen
 * this question in a real interview before?
 */
public class PartitionEqualsSubSetSumFromInternet {

	/**
	 * A utility function that returns true if there is a subset of arr[] with sun
	 * equal to given sum This is a recursion.
	 */
