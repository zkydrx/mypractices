...
/**
 * Created with IntelliJ IDEA. Author: Abbot Date: 2018-01-15 Time: 21:54
 * Description: 414. Third Maximum Number Given a non-empty array of integers,
 * return the third maximum number in this array. If it does not exist, return
