...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2021-03-17 Time: 12:38:56
 * Description: 已知一个搜索二叉树的后续遍历数组posArr, 请根据posArr，重建出整棵树，返回新建树的头结点。
 */
public class ByteDanceMethod {
	...
	public void test1() {
		...
		for (int i = 0; i < times; i++) {
			...
			if (!isSameValueStructure(head, posArrayToBST1(bstPosArr))
					|| !isSameValueStructure(head, posArrayToBST2(bstPosArr))) {
