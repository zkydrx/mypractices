...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-10-05 Time: 23:39
 * Description: Given a non-negative integer num, repeatedly add all its digits
 * until the result has only one digit. Example Given num = 38. The process is
 * like: 3 + 8 = 11, 1 + 1 = 2. Since 2 has only one digit, return 2.
 */
