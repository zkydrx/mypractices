...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-10-03 Time: 14:19
 * Description: Given two strings, you have to find the missing string. Example
 * Given a string str1 = This is an example Given another string str2 = is
 * example
 * <p>
 * Return ["This", "an"]
 */
