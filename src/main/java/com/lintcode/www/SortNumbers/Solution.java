...
public class Solution
{
    ...
    public static void main(String[] args)
    {
        ...
        solution.sortIntegers(new int[]{2, 8, 3, 19, 234, 354, 32, 64, 634, 2345, 1111, 2342, 34, 343, 756, 756, 234, 3234, 23, 13, 345, 27, 0, 19, 7, 6, 4, 5, 1});
        solution.sortNumber(new int[]{2, 8, 3, 19, 234, 354, 32, 64, 634, 2345, 1111, 2342, 34, 343, 756, 756, 234, 3234, 23, 13, 345, 27, 0, 19, 7, 6, 4, 5, 1});
    }
}
