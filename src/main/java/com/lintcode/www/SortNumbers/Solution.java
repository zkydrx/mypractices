...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-09-13 Time: 21:27
 * Description: 给一组整数，按照升序排序，使用选择排序，冒泡排序，插入排序或者任何 O(n2) 的排序算法。 样例 对于数组 [3, 2, 1,
 * 4, 5], 排序后为：[1, 2, 3, 4, 5]。
 */
public class Solution {
	 ...
	 *
	 * [0, 1, 2, 3, 4, 5, 6, 7, 8, 13, 19, 19, 23, 27, 32, 34, 64, 234, 234, 343,
	 * 345, 354, 634, 756, 756, 1111, 2342, 2345, 3234] 冒泡排序算法变种---排序次数：214 [3234,
	 * 2345, 2342, 1111, 756, 756, 634, 354, 345, 343, 234, 234, 64, 34, 32, 27, 23,
	 * 19, 19, 13, 8, 7, 6, 5, 4, 3, 2, 1, 0] 正宗的冒泡排序算法---排序次数：162
	 *
	 */
	/**
	 * 冒泡排序算法的变种。把小的值放到前面。
