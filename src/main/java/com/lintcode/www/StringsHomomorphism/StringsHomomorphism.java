...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-09-18 Time: 19:24
 * Description: Given two strings s and t, determine if they are isomorphic.
 * <p>
 * Two strings are isomorphic if the characters in s can be replaced to get t.
 * <p>
 * All occurrences of a character must be replaced with another character while
 * preserving the order of characters. No two characters may hashMap to the same
 * character but a character may hashMap to itself. 样例 Given s = "egg", t =
 * "add", return true.
 * <p>
...
public class StringsHomomorphism {
	...
	public boolean isIsomorphic(String str1, String str2) {
		...
		for (int i = 0; i < n; i++) {
			...
			/**
			 * If this is not first appearance of current character in str1,then check if
			 * previous appearance ampped to smae character of str2
			 */
