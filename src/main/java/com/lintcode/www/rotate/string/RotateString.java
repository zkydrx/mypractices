...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-12-23 Time: 00:09
 * Description: 给定一个字符串和一个偏移量，根据偏移量旋转字符串(从左向右旋转)
 * <p>
 * 您在真实的面试中是否遇到过这个题？ Yes 样例 对于字符串 "abcdefg".
 * <p>
...
public class RotateString {
	...
	public String getRotateString(String sources, int offset) {
		/**
		 * 考虑到offset 的值可能大于sources的长度，所以进行取余操作。 如果余数为零的那么就是不用移动任何一个元素即可达到要求。
		 *
		 */
