package com.tuku.easyexcel.test.core.handler;
...
public class WriteHandlerTest
{
    ...
    {
        WriteHandler writeHandler = new WriteHandler();
        EasyExcel.write(file).head(WriteHandlerData.class).sheet().table(0).registerWriteHandler(writeHandler).doWrite(data());
        writeHandler.afterAll();
    }
