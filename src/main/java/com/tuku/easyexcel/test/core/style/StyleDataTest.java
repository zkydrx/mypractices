package com.tuku.easyexcel.test.core.style;
...
public class StyleDataTest
{
    ...
    public void t03AbstractVerticalCellStyleStrategy()
    {
        ...
        EasyExcel.write(file07, StyleData.class).registerWriteHandler(verticalCellStyleStrategy).sheet().doWrite(data());
    }

    @Test
    public void t04LoopMergeStrategy()
    {
        EasyExcel.write(file07, StyleData.class).sheet().registerWriteHandler(new LoopMergeStrategy(2, 1)).doWrite(data10());
    }
