...
public class LockTest
{
    ...
    public void test() throws Exception
    {
        ...
        List<Object> list = EasyExcel.read(new FileInputStream("D:\\test\\testbug嘉惠.xlsx")).sheet().headRowNumber(0).doReadSync();
    ...
    {
        List<Object> list = EasyExcel.read(new FileInputStream("D:\\test\\开发部.xls")).sheet().headRowNumber(0).doReadSync();
        for (Object data : list)
        {
