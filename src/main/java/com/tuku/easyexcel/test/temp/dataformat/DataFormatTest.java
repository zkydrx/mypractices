...
import com.tuku.easyexcel.test.core.dataformat.DateFormatData;
import com.tuku.easyexcel.test.temp.Lock2Test;
...
public class DataFormatTest
{
    ...
    public void test() throws Exception
    {
        ...
        List<DataFormatData> list = EasyExcel.read(file, DataFormatData.class, null).sheet().headRowNumber(0).doReadSync();
        ...
        for (DataFormatData data : list)
        {
            ...
            {
                LOGGER.info("格式化：{};{}：{}", dataFormat, dataFormatString, DateUtil.isADateFormat(dataFormat, dataFormatString));
            }
