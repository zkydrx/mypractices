package com.tuku.spider.test.gankio;
...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2020-05-27 Time: 14:05:58
 * Description:
 */
public class SpiderImageGankio {
		...
		for (int i = 1; i <= 5; i++) {
			...
			for (Element e : elements) {
				...
				while (matcher.find()) {
					...
					// 这里可以写成工具类
					File file = new File("E:\\documents\\ganhuo");
