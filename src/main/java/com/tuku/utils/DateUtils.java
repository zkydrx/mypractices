...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2019-12-12 Time: 14:06:42
 * Description:
 */
public class DateUtils {
	 ...
	 * @return
	 */
	private LocalDateTime getLocalDate(Date createTime) {
	...
	public static String getLastMonthLastDay() {
		...
		SimpleDateFormat sm = new SimpleDateFormat(DateUtils.DATE_FORMAT_YYYY_MM_DD);
		// 获取上个月的最后一天
	...
	public static void main(String[] args) {
		String theFirstDayofMonth = DateUtils.getTheFirstDayofMonth();
		System.out.println(theFirstDayofMonth);
		System.out.println(DateUtils.getTheStringDateNow());
		System.out.println("====================");
