...
public class FunctionTest2
{
    public static void main(String[] args)
    {
        ...
        //        System.out.println(test2.compute(2, value -> value * 4, value -> value * value));//输出16
        //        System.out.println(test2.compute2(2, value -> value * 4, value -> value * value));//输出64
        //        System.out.println(test2.compute3(2, value -> value * 4, value -> value * value));//输出16*4=64
        //
