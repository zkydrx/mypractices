...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2019-11-10 Time: 14:32:33
 * Description:"
 */
public class DateTimeExample {
	public static void main(String[] args) {
		...
		System.out.println("year:" + localDate.getYear() + " month:" + localDate.getMonthValue() + " day:"
		...
		System.out.println("hour:" + localTime.getHour() + " minute:" + localTime.getMinute() + " second:"
				+ localTime.getSecond());
