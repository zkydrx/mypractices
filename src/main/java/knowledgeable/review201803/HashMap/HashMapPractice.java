package knowledgeable.review201803.HashMap;
...
/**
 * Created with IntelliJ IDEA. Author: Abbot Date: 2018-03-19 Time: 13:56:41
 * Description: 给定任意一个字符串“To be or not to be that is a question”，
...
public class HashMapPractice {
	...
	public static void countTheChar() {
		...
		for (int i = 0; i < str.length(); i++) {
			...
			/**
			 * put()方法返回与key关联的旧值;如果key没有任何的映射关系， 则返回null（返回null还可能表示该映射之前将null与key关联）
			 */
