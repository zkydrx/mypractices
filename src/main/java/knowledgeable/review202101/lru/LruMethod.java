...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2021-01-29 Time: 15:39:10
 * Description:
 */
public class LruMethod<K, V> extends LinkedHashMap<K, V> {
	...
	public static void main(String[] args) {
		...
		/**
		 * super(capacity, 0.75F, false); [1, 2, 3] [2, 3, 5] [3, 5, 6] [3, 5, 6] [3, 5,
		 * 6] [5, 6, 7] super(capacity, 0.75F, true); [1, 2, 3] [2, 3, 5] [5, 6, 3] [5,
		 * 6, 3] [5, 6, 3] [6, 3, 7]
		 */
