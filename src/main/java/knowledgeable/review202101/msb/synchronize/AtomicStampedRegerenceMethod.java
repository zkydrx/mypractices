...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2021-02-01 Time: 00:04:50
 * Description: AtomicStampedRegerence 可以解决cas的aba问题。 这里写一个小例子来做一下示范
...
public class AtomicStampedRegerenceMethod {
	public static void main(String[] args) {
		...
		new Thread(() -> {
			...
			boolean b1 = atomicStampedReference.compareAndSet(1, 0, atomicStampedReference.getStamp(),
					atomicStampedReference.getStamp() + 1);
			boolean b2 = atomicStampedReference.compareAndSet(0, 1, atomicStampedReference.getStamp(),
					atomicStampedReference.getStamp() + 1);
		...
		new Thread(() -> {
			...
			boolean b = atomicStampedReference.compareAndSet(0, 1, atomicStampedReference.getStamp(),
					atomicStampedReference.getStamp() + 1);
