...
/**
 * Created with IntelliJ IDEA. User: Abbot Date: 2017-08-31 Time: 16:41
 * Description:
 */
public class TestC {
	@Test
	...
	@Test
	public void test2() {
		List<String> list = Arrays.asList("lone", "zky", "one", "1x", "2y", "3z", "Application", "artifacts", "lanuch",
				"eclipse");
		/**
		 * Before java8
		 */
	...
	/**
	 * 自己发挥吧。 1.打印所有的字符串用lamdba来打印
	 */
	@Test
	public void test4() {
		List<String> strings = Arrays.asList("Abbot", "www", "Eclipse", "IntelliJ IDEA", "Fruit", "Apple", "Microsoft",
				"Google", "BaiDu");
