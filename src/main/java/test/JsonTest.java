...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2018-07-06 Time: 14:52:28
 * Description:
 */
public class JsonTest {
	...
	public void jsonTest() {
		...
		/**
		 *
		 * 这是组装好以后的json格式的数据。从下面的组装情况来看。说明json组装的报文是无序列的。 就是并不是按照先后的put顺序而进行排列展示的。 {
		 * "zky1": "drx1", "zky3": "drx3", "zky2": "drx2", "zky5": "drx5", "data": [ {
		 * "apple1": 10001, "apple2": 10002, "apple3": 10003, "apple4": 10004, "apple5":
		 * 10005 }, { "apple1": 10001, "apple2": 10002, "apple3": 10003, "apple4":
		 * 10004, "apple5": 10005 }, { "apple1": 10001, "apple2": 10002, "apple3":
		 * 10003, "apple4": 10004, "apple5": 10005 } ], "zky4": "drx4" }
		 * 
		 * 
		 * 说明json是无序的
		 */
		...
		/**
		 * test the override the value find the key and put the new values.
		 */
	...
	public void testKindsOfJson() {
		...
		/**
		 * kinds of two ["value"] ["google1","google2","google3","google4"]
		 */
		JSONArray jsonArray = new JSONArray();
		...
		/**
		 * kinds of three {"String":["value"]} {"fruit":["apple","banana","tmatoes"]}
		 */
		...
		/**
		 * kinds of four [{"String":"value","String":"value"}]
		...
		/**
		 * { "A": [ { "id": "1", "name": "Apple", "price": "3" }, { "id": "2", "name":
		 * "Avocado", "price": "22" }, { "id": "3", "name": "Orange", "price": "2" } ],
		 * "B": [ { "id": "4", "name": "Durian", "price": "50" }, { "id": "5", "name":
		 * "Lichee", "price": "6" }, { "id": "6", "name": "Potato", "price": "1" } ],
		 * "C": [ { "id": "7", "name": "Tomato", "price": "1" }, { "id": "8", "name":
		 * "Banana", "price": "2.5" }, { "id": "9", "name": "Watermelon", "price": "1" }
		 * ] }
		 */
