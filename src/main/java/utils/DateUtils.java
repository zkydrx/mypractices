...
/**
 * Created with IntelliJ IDEA. Author: zky Date: 2019-07-04 Time: 10:56:14
 * Description:
 */
public class DateUtils {
	...
	/**
	 * 获取指定时间的毫秒数 example 获取2019-01-01对应的毫秒数为：1546272000000L
	 *
	 * @param date
	 * @return
	 */
	public static long getTheDateMillis(String date) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		Calendar calendar = Calendar.getInstance();
		try {
			Date dateParse = df.parse(date);
